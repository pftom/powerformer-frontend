...
in HTML meanwhile.
- `fab run`：Run the build locally with docker-compose.
- `fab deploy`: Handle the whole process of building, pushing and pulling docker image,
...
env.hosts = ['root@powerformer.com']

image_repo = 'pftom/pf-client'
container_name = 'yyj_client'
oss_vendor = 'http://oss-cn-hangzhou.aliyuncs.com'
bucket_url = 'http://powerformer.oss-cn-hangzhou.aliyuncs.com'
